...
class Info_System:
	def __init__(self,root):
		...
		self.p5=PhotoImage(file='kanheri.png')
		...
		btn_5=Button(Info_frame ,text="KANHERI CAVES", image=self.p5,compound=LEFT,font=("times new roman",20,"bold"),bg="dark blue",fg="white").grid(row=5,column=0,pady=10)
